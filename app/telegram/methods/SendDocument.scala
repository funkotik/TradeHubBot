...
/** Use this method to send general files. On success, the sent Message is returned.
  ...
  * @param document             InputFile or String File to send. Pass a file_id as String to send a file that exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a file from the Internet, or upload a new one using multipart/form-data.
