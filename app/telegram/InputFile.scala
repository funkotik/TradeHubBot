...
object InputFile {
  private[telegram] final case class FileId(fileId: String) extends InputFile
  private[telegram] final case class Path(path: java.nio.file.Path) extends InputFile
  private[telegram] final case class Contents(filename: String, contents: Array[Byte]) extends InputFile
  private[telegram] final case class ByteString(filename: String, contents: akka.util.ByteString) extends InputFile
